...
```html
<div bar-chart id="myChart" class="st-chart" data="data"></div>
// or
<div line-chart id="myChart" class="st-chart" data="data"></div>
// ar
<div pie-chart id="myChart" class="st-chart" data="data"></div>
```
